...
class TrainData(data.Dataset):
    def __init__(self, crop_size, train_data_dir, list_path=None, only_h_flip=False):
        ...
        with open(list_path) as f:
            ...
            # gt_names = rain_names
            gt_names = [i.split('_')[0] + '_clean.png' for i in rain_names]
    ...
    def get_images(self, index):
        ...
        rain_path = os.path.join(self.train_data_dir, 'data', rain_name)
...
class Test_a(data.Dataset):
    ...
    def get_images(self, index):
        rain_name = self.rain_names[index]
        gt_name = self.gt_names[index]
        rain_path = os.path.join(self.val_data_dir, "data", rain_name)
