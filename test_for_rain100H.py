...
from datasets.Rain_Dataloader import TestData_for_Rain100H
from models import *
...
parser.add_argument('--data_dir', required=True, type=str, help='path to Rain100H test root (rain_heavy_test)')
parser.add_argument('--save_dir', default='./results/rain100H', type=str, help='path to save restored images')
...
def main():
    ...
    dataset = TestData_for_Rain100H(args.local_size, test_dir)
    ...
    with torch.no_grad():
        for batch in tqdm(loader, desc='Testing Rain100H'):
